    ...
    public async Task<string> CreateMessageWithOpenAIAsync(string message)
    {
        ...
        var requestBody = new
        {
            ...
            messages = new[]
            {
                ...
                {
                    role = "system",
                    content = @"Sen Travix.WebUI adlı otel arama ve rezervasyon platformunun müşteri destek temsilcisisin.
...
- Sonunda Travix.WebUI ekibi adına kapanış yap.
